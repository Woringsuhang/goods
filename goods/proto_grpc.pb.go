...
func (c *goodsClient) GoodsGet(ctx context.Context, in *GoodsGetReq, opts ...grpc.CallOption) (*GoodsGetResp, error) {
	out := new(GoodsGetResp)
	err := c.cc.Invoke(ctx, "/stream.Goods/GoodsGet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGoodsServer) GoodsGet(context.Context, *GoodsGetReq) (*GoodsGetResp, error) {
...
func _Goods_GoodsGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GoodsGetReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodsServer).GoodsGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stream.Goods/GoodsGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GoodsGet(ctx, req.(*GoodsGetReq))
	}
...
var Goods_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GoodsGet",
			Handler:    _Goods_GoodsGet_Handler,
		},
	},
